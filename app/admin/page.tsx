...
export default function Admin() {
  ...
  const ajouterProduit = async () => {
    if (!form.nom || !form.prix || !form.categorie) { setMessage("❌ Remplis nom, prix et catégorie !"); return; }
    setChargement(true);
    const res = await fetch("/api/produits", {
      method: "POST",
      ...
      <div style={{
        ...
        <input
          ...
          style={{
            ...
            border: `2px solid ${erreurMdp ? "#e74c3c" : "rgba(212,163,89,0.2)"}`,
            borderRadius: "14px", padding: "16px 20px",
            fontSize: "15px", outline: "none", marginBottom: "12px",
            fontFamily: "'Jost', sans-serif",
            color: "#fdf6ec", letterSpacing: "2px",
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0500", fontFamily: "'Jost', sans-serif", color: "#fdf6ec" }}>
      <style>{`
        ...
        input:focus, textarea:focus, select:focus { border-color: rgba(212,163,89,0.6) !important; box-shadow: 0 0 0 3px rgba(212,163,89,0.1); }
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          <a href="/" style={{
            color: "rgba(212,163,89,0.5)", fontSize: "13px",
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "40px clamp(16px,3vw,32px)" }}>
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <span style={{ fontSize: "24px" }}>➕</span> Ajouter un produit
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px" }}>
            {[
              ...
              <div key={key}>
                <label style={{ fontSize: "11px", fontWeight: 700, color: "rgba(212,163,89,0.5)", letterSpacing: "2px", textTransform: "uppercase", display: "block", marginBottom: "10px" }}>{label}</label>
            ...
            <div>
              <label style={{ fontSize: "11px", fontWeight: 700, color: "rgba(212,163,89,0.5)", letterSpacing: "2px", textTransform: "uppercase", display: "block", marginBottom: "10px" }}>Devise</label>
              <select value={form.devise} onChange={e => setForm({ ...form, devise: e.target.value })}
                style={{
                  ...
                  fontSize: "14px", outline: "none",
                  fontFamily: "'Jost', sans-serif",
                  color: "#fdf6ec", cursor: "pointer", transition: "border-color 0.2s"
                }}>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={{ fontSize: "11px", fontWeight: 700, color: "rgba(212,163,89,0.5)", letterSpacing: "2px", textTransform: "uppercase", display: "block", marginBottom: "10px" }}>URL de l'image</label>
              <input type="url" placeholder="https://..." value={form.image_url}
                ...
                style={{
                  ...
                  fontSize: "14px", outline: "none",
                  fontFamily: "'Jost', sans-serif",
                  color: "#fdf6ec", transition: "border-color 0.2s"
                }} />
              {form.image_url && (
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={{ fontSize: "11px", fontWeight: 700, color: "rgba(212,163,89,0.5)", letterSpacing: "2px", textTransform: "uppercase", display: "block", marginBottom: "10px" }}>Description</label>
          ...
          {message && (
            <div style={{
              ...
              background: message.startsWith("✅") ? "rgba(39,174,96,0.12)" : "rgba(231,76,60,0.12)",
              border: `1px solid ${message.startsWith("✅") ? "rgba(39,174,96,0.3)" : "rgba(231,76,60,0.3)"}`,
              ...
              {produits.map((p, i) => (
                <div key={p.id} style={{
                  ...
                  <img src={p.image_url || "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=100"} alt={p.nom} style={{
                    ...
                    objectFit: "cover", border: "1px solid rgba(212,163,89,0.15)",
                    flexShrink: 0
                  }} />
